...
1. Confirm the target domain exists under standards/. If it does not, run /add_domain first.
2. Copy tasks/_task_template/ to tasks/$ARGUMENTS/.
3. Fill in task.md, the output template, and the README. Point the task at standards/shared/style.md and the domain's standard. Read config from the local config.md. Write output to output/$ARGUMENTS/.
